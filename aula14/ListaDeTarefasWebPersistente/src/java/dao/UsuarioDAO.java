...
public class UsuarioDAO {
    ...
    public static boolean inserirUsuario(Usuario u) {
        ...
        try (Connection connection = Conexao.abrirConexao()) {
            ...
            PreparedStatement stmt = connection.prepareStatement("INSERT INTO lista_tarefas.usuario (email, senha, imagem) VALUES (?, ?, ?)");
    ...
    public static boolean atualizarUsuario(Usuario u) {
        ...
        try (Connection connection = Conexao.abrirConexao()) {
            ...
            PreparedStatement stmt = connection.prepareStatement("UPDATE lista_tarefas.usuario SET email = ?, senha = ?, imagem = ? WHERE id = ?");
